For this project we'll focus on creating an entire web landing page from an already provided design using all the skills learnt so far on the odin project.
